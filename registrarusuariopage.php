...
<div id="contenido">
  ...
  <div id="Perfil">
      ...
      <!--Solo para usuarios que yan están logeados-->
    ...
    <h3>Completa estos campos para registrarte</h3>
    <section id="Form1">
    <form action="registrarusuario.php" method="post" name="frRegistro" onsubmit="return registrarUsuario();">
      <label class="campoform">Nombre de Usuario:</label>
      <input type='text' name='txtNombreUsuario' class='cm' required>
      <br>
      <label class="campoform">Contrase&ntilde;a:</label>
      <input type='password' name='txtClave' class='cm' required>
      <br>
      <label class="campoform">Repetir Contrase&ntilde;a:</label>
      <input type='password' name='txtRepetirClave' class='cm' required>
      <br>
      <label class="campoform">Nombre:</label>
      <input type='text' name='txtNombre' class='cm' required>
      <br>
      <label class="campoform">Apellidos:</label>
      <input type='text' name='txtApellidos' class='cm' required>
      <label class="campoform">Correo Electronico:</label>
      <input type='text' name='txtCorreo' class='cm' required>
      <label class="campoform">Direcci&oacute;n:</label>
      <input type='text' name='txtDireccion' class='cm' required>
      <label class="campoform">Foto:</label>
      <input type='file' name='txtFoto' class='cm'>
      <br>
...
<div id="pie">
  <p>
    ...
    <br>
    <a href="registrarusuariopage.php#Perfil">Registrate</a> | <a href="sugerencias.php#Perfil">Sugerencias</a> | <a href="contactanos.php#Perfil">Contactos</a>
  </p>
</div>
