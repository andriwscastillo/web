...
<div id="contenido">
  <div id="Perfil">
        ...
        <!--Solo para usuarios que ya estan logeados-->
    ...
    <h3>Dejanos aquí tu sugerencia</h3>
    <section id="Form1">
    <form action="contactanos.php" method="post" name="frCliente" onsubmit="return validarCampos();">
      ...
      <br>
      <label class="campoform">Sugerencia:</label>
      <input type='text' name='txtOtroTelefono' class='cm' required>
      <br>
      <label class="campoform">Otra Sugerencia:</label>
      <input type='text' name='txtOtroContacto' class='cm' required>
      <br>
